...
(function () {
  ...
  function customQuery(selector, context) {
    //Selector may have been split, so just try and query it again
    try {
      return context.querySelectorAll(selector);
    } catch (e) {
      //
    }
    console.log("Custom", selector, context);
    return [];
  }
  ...
  function querySelectorAll(selector, context) {
    try {
      ...
      return selector.map((s) => customQuery(s, context)).flat();
    }
  }
    ...
    each(getSplitValues(eventFullName), function (i, eventFullName) {
      ...
      _this.each(function (i, ele) {
        ...
        var finalCallback = function finalCallback(event) {
          if (
            isEventBubblingProxy &&
            (event.___ot
              ? event.___ot !== nameOriginal
              : event.type !== nameOriginal ||
                (event.target["___i" + nameOriginal] &&
                  (delete event.target["___i" + nameOriginal],
...
window.jQuery = window.$ = window.cash;
